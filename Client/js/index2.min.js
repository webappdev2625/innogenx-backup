...
function clickHandler(e) {
  ...
  switch (e.target.id) {
    case "prevBanner":
      showPrevSlide(o("banner"), 100, "bannerOffset", "bannerMaxOffset");
      break;
    case "nextBanner":
      showNextSlide(o("banner"), -100, "bannerOffset", "bannerMaxOffset");
      break;
    case "prevOffer":
      (t = screen.width > 1150 ? 60 : 100),
        showPrevSlide(o("offer"), t, "offerOffset", "offerMaxOffset");
      break;
    case "nextOffer":
      (t = screen.width > 1150 ? -60 : -100),
        showNextSlide(o("offer"), t, "offerOffset", "offerMaxOffset");
      break;
...
function showPrevSlide(e, t, n, o) {
  0 != g[n] ? (g[n] += t) : (e.style.left = g[n] = g[o]),
    elementTransition(e),
    picVidSlide(e, g[n]);
}
function showNextSlide(e, t, n, o) {
...
observer.observe(),
  ...
  (g.offerMaxOffset = -100),
  (g.testimonialMaxOffset = -100),
  (window.onload = function () {
    (o("copyright").textContent =
      "©" + new Date().getFullYear() + " - Genius Phone Repair"),
      addEventListeners(),
      setTimeout(() => {}, 3e3);
  });
